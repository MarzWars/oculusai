...
| 🗂️ **File Attachments & Code Uploads** | Drag and drop or upload file attachments (.py, .js, .txt, etc.) directly into the chat interface for deep codebase analysis |
...
| 🧬 **AI Inference Memory (`ai_notes`)** | An automated behavioral-inference memory layer generated by the model to remember design styles, tone preferences, and guidelines |
