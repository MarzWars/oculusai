...
<div class="app-shell">
    ...
    <header>
        ...
        <div class="header-actions">
            ...
            <button class="brain-btn" onclick="toggleBrain()" title="Oculus Brain (Memory)">🧠 Brain</button>
...
<!-- Oculus Brain Memory Drawer -->
<div class="brain-drawer" id="brainDrawer">
    <div class="brain-drawer-header">
        <h3>🧠 Oculus Brain</h3>
        <button class="close-drawer-btn" onclick="toggleBrain()">×</button>
    </div>
    <div class="brain-drawer-content">
        <div class="brain-loading">Loading brain state...</div>
    </div>
</div>
<div class="brain-overlay" id="brainOverlay" onclick="toggleBrain()"></div>
...
# ─────────────────────────────────────────
# FILE UPLOAD CACHE AND ENDPOINTS
# ─────────────────────────────────────────
...
def ask():
    ...
    # Clear uploaded files cache immediately so they are only used for this single query
